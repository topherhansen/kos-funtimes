function GetScienceData
{
	...
	UsePartEvent("SETI ProbeSTACK 2","ModuleScienceExperiment","Log Temperature").
...
function DeployFarring
{
	UsePart("fairingSize1", "ModuleProceduralFairing", "deploy").	
}

function DeleteStrayData
{
	UsePart("SETI ProbeSTACK 1","ModuleScienceExperiment","delete data").
	UsePart("SETI ProbeSTACK 2","ModuleScienceExperiment","delete data").
...
function ListPartModules
{
	...
	if p:length = 0 { print "no part found". return. }
